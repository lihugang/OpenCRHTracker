...
const scopeLabelMap: Record<string, string> = {
    ...
    'api.allocation': '配属信息',
    'api.allocation.emu': '动车组配属',
    'api.allocation.emu.read': '读取动车组配属',
    'api.records': '记录',
    ...
    'api.timetable.train.circulation': '列车交路图',
    'api.timetable.train.circulation.image': '列车交路图图片',
    'api.timetable.train.circulation.image.read': '列车交路图图片生成',
