...
export const deployDocsSections: DocsContentSection[] = [
    ...
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                text: '这一组决定管理员流量统计、服务器监控与 12306 请求计数的落盘位置、保留天数和定时写盘间隔。',
                cards: [
                    {
    ...
    },
    {
        ...
        blocks: [
            ...
            {
                type: 'paragraph',
                text: '应用会在 logs/ 目录下按天滚动写入日志，同时按 data.runtime 配置把管理员流量统计、服务器监控统计和 12306 请求计数分别写入独立文件。12306 请求计数不再进入日志。'
            }
        ]
    },
    {
