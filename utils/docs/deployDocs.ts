...
export const deployDocsSections: DocsContentSection[] = [
    ...
    },
    {
        ...
        "summary": "服务器启动时会读取 data/config.json 下的配置文件，并校验配置合法性。",
        "blocks": [
            {
            ...
            },
            {
                ...
                "cards": [
                    ...
                    },
                    {
                        ...
                        "valueType": "object",
                        "required": true,
                        "description": "抓取接口固定参数，包含 eKey、jsonpCallback 和 routeProbeCarCode。",
                        "notes": []
                    },
                    {
                        ...
                        "valueType": "integer",
                        "required": true,
                        "description": "查询车次、车组号和畅行码接口的最小调用间隔，单位毫秒。",
                        "notes": []
                    },
                    {
                        ...
                        "valueType": "integer",
                        "required": true,
                        "description": "通过 12306 搜索接口检索启用车次号的最小调用间隔，单位毫秒。"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "valueType": "integer",
                        "required": true,
                        "description": "控制车次探测任务的失败重试次数、单批处理上限和检查点落盘频率。"
                    },
                    {
                        "path": "spider.scheduleProbe.refresh",
                        "valueType": "object",
                        "required": true,
                        "description": "控制时刻表刷新任务的批次、TTL 和生成间隔。"
                    },
                    {
                        "path": "spider.scheduleProbe.probe",
                        "valueType": "object",
                        "required": true,
                        "description": "探测重试次数与 12306 接口数据异常的重试策略。"
                    },
                    {
            ...
            },
            {
                ...
                "cards": [
                    ...
                    },
                    {
                        ...
                        "valueType": "object",
                        "required": true,
                        "description": "铁路畅行码资产文件路径、下载地址与刷新时间。",
                        "notes": [
                            "refresh.enabled=true 时 provider 必填。",
                            "refresh.refreshAt 必须是 HHmm 字符串。"
                        ]
            ...
            },
            {
                ...
                "cards": [
                    ...
                    },
                    {
                        ...
                        "valueType": "object",
                        "required": true,
                        "description": "API Key 名称长度限制，包含 minLength 和 maxLength。",
                        "notes": [
                            "前端签发表单和服务端接口会共用这组限制。",
                    ...
                    },
                    {
                        ...
                        "required": false,
                        "description": "管理员用户 ID 列表，命中的 webapp 登录用户会额外获得 api.admin 权限。",
                        "notes": [
                    ...
                    },
                    {
                        ...
                        "valueType": "object",
                        "required": true,
                        "description": "密码派生算法参数，包含 keyLength、cost、blockSize、parallelization。",
                    }
                ]
            },
            {
                ...
                "cards": [
                    ...
                    },
                    {
                        ...
                        "valueType": "object",
                        "required": true,
                        "description": "用户记录和 API Key 记录缓存的容量与 TTL。"
                    },
                    {
                    ...
                    },
                    {
                        ...
                        "valueType": "object",
                        "required": true,
                        "description": "反馈接口后端校验使用的长度限制配置，分别控制创建反馈正文、回复正文和管理员修改标题时的最小/最大长度。",
                        "notes": [
                    ...
                    },
                    {
                        ...
                        "valueType": "object",
                        "required": true,
                        "description": "当前日、历史、搜索索引和 sitemap 的缓存时长。",
                        "notes": [
                    ...
                    },
                    {
                        ...
                        "valueType": "array<string>",
                        "required": true,
                        "description": "前端可签发 API Key 时允许选择的最大权限范围。"
                    }
                ]
            },
            {
                ...
                "cards": [
                    {
                        ...
                        "notes": [
                            "只能使用 build_today_schedule、generate_route_refresh_tasks、dispatch_daily_probe_tasks、clear_daily_probe_status、cleanup_revoked_api_keys、export_daily_records。",
                            "为空数组表示全部启用。"
                        ]
                    },
                    {
            ...
            },
            {
                ...
                "cards": [
                    ...
                    {
                        "path": "cost.fixed.authIssueApiKey / authListApiKeys / authRevokeApiKey",
                        "valueType": "integer",
                        "required": true,
