        ...
        blocks: [
            ...
            },
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        required: true,
                        description:
                            'Controls the latest execution time for first-wave probe task dispatch; 0000 disables it.',
                        notes: ['Only affects dispatch execution time, not the real departure time.']
                    },
                    {
            ...
            },
            {
                ...
                cards: [
                    ...
                    {
                        path: 'cost.fixed.searchIndex / timetableTrainCurrent / timetableTrainHistory / exportDailyIndex / exportDaily',
                        valueType: 'integer',
                        required: true,
