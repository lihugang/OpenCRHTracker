    ...
    },
    {
        ...
        blocks: [
            ...
            },
            {
                ...
                title: '接口行为',
                items: [
                    '当前不新增独立公开接口，而是把 circulation 直接并入 /api/v1/timetable/train/{trainCode}/current 的响应。',
        ...
        blocks: [
            ...
            },
            {
                ...
                items: [
                    ...
                    '新车次或规范化时刻表内容发生变化后，系统会把车次加入交路刷新队列，并按这些车次当前全部经停站的并集派发车站大屏任务；自动任务每隔 task.circulation.stationBoard.fullSweepIntervalDays 天对当天时刻表全部经停站做一次全量兜底。',
